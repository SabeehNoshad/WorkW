...
//		       
	...
	//-----------------------************************************ Test 2 for the auction Bidding --------------------------------------
	@Test 
	public boolean auctionBiddingTest( Integer times,String email, String pass) throws InterruptedException {
		setUp();
		getterMethod_Defaults defaults = new getterMethod_Defaults();
		  String currentURL = "";
...
//		       
	...
	//--------------------------------********************* list view table view test case------------------------------
	@Test 
	public boolean auctionListViewTest( Integer times,String email, String pass) throws InterruptedException {
		setUp();
		getterMethod_Defaults defaults = new getterMethod_Defaults();
		  String currentURL = "";
...
//		       
				//Thread.sleep(5000);
				auctionMehtod auction = new auctionMehtod(driver);
				auction.auctionListViewTableView();
			 ApplicationNew.resTime("Response time: " + pageLoadTime + " milliseconds" );
			 ApplicationNew.logError("Auction Table View Test Sucessfull");
		        tearDown();
		        return true;
		       
		 } catch (Exception e) {
			 currentURL = driver.getCurrentUrl();
			 ApplicationNew.logError("Error occurred during Auction Table View on URL: " + currentURL + "\nError message: "  + e.getMessage());
		        return false;
		 }
		 finally {
			 // Handle exceptions or log errors if createPost fails

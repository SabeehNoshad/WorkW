...
// EMPLOYEE UPDATE MODULE
    ...
    By careersDesignationList				= By.xpath("//form[@id='createCareer']/div/div/div[2]/div/div/div/div/span/input");
    By careersDesignationListClick          = By.cssSelector(".ant-select-item-option-content");
    By careersDescription					= By.xpath("//div[2]/div/div/div/div/div[2]/div/div[2]/div");
    By careersSalaryRange					= By.xpath("//form[@id='createCareer']/div[3]/div/div/div[2]/div/div/div/div/div/div/div/input");
    By careersMaxiSalary					= By.xpath("//form[@id='createCareer']/div[3]/div/div/div[2]/div/div/div[2]/div/div/div/div/input");
    By careersDepartmentList				= By.xpath("//form[@id='createCareer']/div[4]/div/div[2]/div/div/div/div/span/input");
    By careersDepartmentListClick			= By.xpath("/div[6]/div/div/div/div[2]/div/div/div/div/div");
    By careersSupervisorList				= By.xpath("//form[@id='createCareer']/div[5]/div/div[2]/div/div/div/input");
    By careersSuperVisorClick				= By.xpath("//form[@id='createCareer']/div[5]/div/div[2]/div/div/div[2]/span/div/div/p");
    By careersInterviewerList				= By.xpath("//form[@id='createCareer']/div[6]/div/div[2]/div/div/div/input");
    By careersInterviewerClick				= By.xpath("//form[@id='createCareer']/div[6]/div/div[2]/div/div/div[2]/span/div/div/p");
    By careersPostReviwerList				= By.cssSelector(".ant-form-item:nth-child(7) input");
    By careersreviewerClick					= By.xpath("//form[@id='createCareer']/div[7]/div/div[2]/div/div/div[2]/span/div/div/p");
    By careersHiringBudyList				= By.xpath("//form[@id='createCareer']/div[8]/div/div[2]/div/div/div/input");
    By careersHiringBudyCLick				= By.xpath("//form[@id='createCareer']/div[8]/div/div[2]/div/div/div[2]/span/div");
    By careersCityList						= By.xpath("//form[@id='createCareer']/div[11]/div/div[2]/div/div/div/div/span/input");
    By careersCityClick						= By.xpath("//form[@id='createCareer']/div[11]/div/div[2]/div/div/div/div[2]/div/div/div/div[2]/div/div/div/div");
    By careersSkills						= By.cssSelector(".ant-select-selection-overflow");
    By careersExperience					= By.xpath("//form[@id='createCareer']/div[13]/div/div[2]/div/div/input");
    By careersJobTypeList					= By.xpath("//form[@id='createCareer']/div[14]/div/div/div[2]/div/div/div/div/span/input");
    By careersJobTypeClick					= By.xpath("//div[5]/div/div/div/div[2]/div/div/div/div[2]/div");
    By careersJobShiftList					= By.xpath("//form[@id='createCareer']/div[14]/div[2]/div/div[2]/div/div/div/div/span/input");
    ...
    By careersCareerClick					= By.xpath("//div[14]/div/div/div/div[2]/div/div/div/div/div");

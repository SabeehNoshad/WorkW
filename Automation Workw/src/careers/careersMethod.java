...
public class careersMethod extends Base_page{
	...
	public void createComposer() throws InterruptedException {
		...
		CareerDesignation.sendKeys(text.getemployeeDesignation());
		...
		CareerSupervisorList.sendKeys(text.getCompantMember1());
		Thread.sleep(3000);
		...
		CareerInterviewersList.sendKeys(text.getCompantMember1());
		Thread.sleep(3000);
		...
		CareerpostReviewerList.sendKeys(text.getCompantMember1());
		Thread.sleep(3000);
		...
		CareerHiringBuddy.sendKeys(text.getCompantMember1());
		Thread.sleep(3000);
